...
{
    [MenuItem("Tools/AB包加密/创建AB包版本文件/Window 版本")]
    ...
    [MenuItem("Tools/AB包加密/解密AB包版本文件/Window 版本")]
    ...
    [MenuItem("Tools/AB包加密/创建AB包版本文件/Android 版本")]
    ...
    [MenuItem("Tools/AB包加密/解密AB包版本文件/Android 版本")]
    ...
    [MenuItem("Tools/AB包加密/创建AB包版本文件/IOS 版本")]
    ...
    [MenuItem("Tools/AB包加密/解密AB包版本文件/IOS 版本")]
